            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">                                      
                        ...
                        <a class="collapse-item" href="/view/pages/brand.php">Thương hiệu</a>
                        <a class="collapse-item" href="/view/pages/category.php">Loại sản phẩm</a>
                        <a class="collapse-item" href="/view/pages/user.php">Tài khoản</a>
                    </div>
                </div>
            </li>
